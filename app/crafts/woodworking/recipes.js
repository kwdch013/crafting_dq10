registerDQ10CraftRecipes("woodworking", [
  {
    id: "wood-3x3-standard",
    name: "木工 9マステンプレート",
    items: [
  ...
  },
  {
    ...
    name: "木工 3マステンプレート",
    items: [
      { id: "part-1", name: "上", optionId: "parallel", gridCell: { row: 1, column: 2 }, current: 0, successMin: 65, successMax: 82 },
      { id: "part-2", name: "中央", optionId: "parallel", gridCell: { row: 2, column: 2 }, current: 0, successMin: 65, successMax: 82 },
      { id: "part-3", name: "下", optionId: "parallel", gridCell: { row: 3, column: 2 }, current: 0, successMin: 65, successMax: 82 },
    ],
  },
]);
